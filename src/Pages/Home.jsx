...
import IntroImage from '../../src/assets/Images/images.jpeg';
...
const Home = () => {
  return (
    <Container>
      {/* Hero Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 py-20 gap-12">
        ...
        <div className="relative">
          ...
          />
          <div className="absolute top-5 left-5 bg-black bg-opacity-50 text-white p-2 rounded-md">
            <p>New Arrivals!</p>
          </div>
        </div>
      </div>
